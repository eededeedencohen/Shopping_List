...
function ModalShowProductGroups({ isOpen, onClose, barcode, onSelectGroup }) {
  const { fullGroups, isLoadingGroups } = useFullGroupsWithProduct(barcode);
  const {
    deleteGroup,
    renameGroup,
    createGroup,
...
export default ModalShowProductGroups;
