...
function ProductsListServer() {
  ...
  return (
    <>
            ...
            {filteredProducts.map((product) => (
              <div className={styles['list__product-card']} key={product.barcode}>
                ...
                <div className={styles['list__product-details']}>
                  ...
                  >
                    <ServerProductImage barcode={product.barcode} />
                  </div>
                </div>
      ...
      <button
        className={styles['fab-add-product']}
...
export default ProductsListServer;